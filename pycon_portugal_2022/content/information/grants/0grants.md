...
**PyCon Europe 2021 offers grants to those who might otherwise not be able to attend, won't hesitate to participate.** We will cover the full amount of the ticket for the selected for the opportunity grant recipients.
...
* Additionally, the selection process attempts to promote a more diverse PyCon Europe. While encouraging diversity takes many forms, we're happy to use the opportunity grant program as a very direct method of supporting diversity within the Django community. In particular, our grant program prioritizes those who belong to under-represented or marginalized groups in our industry, as attending our event is likely to be more difficult and financially onerous for them.
